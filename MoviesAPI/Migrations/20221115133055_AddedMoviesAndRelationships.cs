...
{
    public partial class AddedMoviesAndRelationships : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieMovieTheaters", x => new { x.MovieId, x.MovieTheaterId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieMovieTheaters_MovieTheaterId",
